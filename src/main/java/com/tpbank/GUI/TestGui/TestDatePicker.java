...
public class TestDatePicker {
    ...
    public static void main(String[] args) {
        ...
        URL dateImageURL = TestDatePicker.class.getResource("/images/datepickerbutton1.png");
...
//        dateSettings.setDefaultYearMonth(yearMonthJuly);
        ...
        // See also: JButton.setPressedIcon() and JButton.setDisabledIcon().
        // Get the example image icon.
        URL timeIconURL = TestDatePicker.class.getResource("/images/timepickerbutton1.png");
